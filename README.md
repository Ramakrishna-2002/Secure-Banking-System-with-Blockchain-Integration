...
1. **Frontend** — User interface for interacting with the banking system
2. **Backend** — Python-based application logic handling user requests, authentication and transaction processing
3. **Blockchain Layer** — Solidity smart contracts deployed to manage and verify transactions in a decentralised manner
